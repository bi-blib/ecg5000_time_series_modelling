...
def main():
    ...
    # Restrict to abnormal beats only (drop class 0 / healthy), then shift the
    # remaining labels down by 1 so they stay a contiguous 0-indexed range -
    # CrossEntropyLoss and the model's output_size both assume that.
