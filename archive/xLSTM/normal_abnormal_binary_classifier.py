...
def main():
    ...
    X_train_ros, y_train_ros = oversampleTrainingData(
        X_train_scaled, y_train, task="binary"
    )
    ...
    # Loss function
    # Binary training is intentionally unweighted because it is not oversampled.
